...
stage1_class_mapping = {0: 0, 1: 1, 2: 2, 3: 3, 4: 3, 5: 4, 6: 5, 7: -1}
...
data = dict(
    ...
    train=dict(
        ...
        split="train",
        data_root=data_root,
        class_mapping=stage1_class_mapping,
        transform=[
    ...
    test=dict(
        ...
        data_root=data_root,
        class_mapping=stage1_class_mapping,
        pred_check_dir="exp/forest/semseg-litept-small-v1m1-stage1/result",
        transform=[
            dict(type="CenterShift", apply_z=True),
        ],
        test_mode=True,
