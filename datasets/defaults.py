...
class DefaultDataset(Dataset):
    ...
    def get_data_list(self):
        ...
        for split in split_list:
            ...
            # with open('forest_{}_0610.txt'.format(split), 'r') as file:
            #     data_files = file.readlines()
            #     data_files = ['/iopsstor/scratch/cscs/yyue/3DSSL/Pointcept_0512/Pointcept/data/forest/' + split + '/' + file.split('\n')[0] for file in data_files]
    ...
    def get_data(self, idx):
        ...
        for asset in assets:
            ...
            try:
                ...
                print(f"Something went wrong: {e} ", os.path.join(data_path, asset))
        data_dict["name"] = name
        ...
        if "coord" in data_dict.keys():
            ...
            print(f"this file no coord: ", os.path.join(data_path, asset))
        ...
        if "segment" in data_dict.keys():
            # data_dict["segment"] = data_dict["segment"].reshape([-1]).astype(np.int32) - 1
