#!/usr/bin/env python
"""V27 batch inference - Base model + slope augmentation + grid_size=0.025"""
...
WEIGHT = "/root/autodl-tmp/exp/forest/semseg-litept-base-v1m1-loss-v2-clean-v27/model/model_best.pth"
GRID_SIZE = 0.025
OUT_ROOT = "/root/autodl-tmp/exp/forest/semseg-litept-base-v1m1-loss-v2-clean-v27/inference"
...
class V27Inference(_Inference):
    def _build_model(self):
        ...
        print("Loading V27 weights: " + self.weight_path, flush=True)
        ...
        ep = ckpt["epoch"]
        print("V27 model epoch " + str(ep) + " | params: " + format(nt, ",") + " | " + str(self.device), flush=True)


def main():
    os.makedirs(OUT_ROOT, exist_ok=True)
    sep = "=" * 60
    print("V27 Batch Inference", flush=True)
